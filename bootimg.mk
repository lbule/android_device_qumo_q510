...
$(INSTALLED_RAMDISK_TARGET): $(MKBOOTFS) $(INTERNAL_RAMDISK_FILES) | $(MINIGZIP)
	...
	cmp -s device/qumo/q510_qumo/rootdir/custom_init out/target/product/q510_qumo/root/init; \
	RETVAL=$$?; \
	if [ $$RETVAL -eq 1 ]; then \
		mv out/target/product/q510_qumo/root/init out/target/product/q510_qumo/root/init2; \
		cp device/qumo/q510_qumo/rootdir/custom_init out/target/product/q510_qumo/root/init; \
	fi
